...
String id=request.getParameter("U_Id");
       ...
       String U_Ph=request.getParameter("U_Ph"); 
       
        DbConnection db=new DbConnection();
        int id1=Integer.parseInt(id);

        String query1="Update user_phr_details set  User_Name='"+U_Name+"',DOB='"+Date+"',Qualification='"+Quali+"',Profession='"+Prof+"',age='"+Age+"',Opeartion='"+Surgery+"',Issuses='"+Issues+"',Bp='"+BB+"',height='"+Height+"',weight='"+Weight+"',BloodGroup='"+BG+"', C_date='"+C_Date+"',U_Ph='"+U_Ph+"' where User_Id='"+id1+"'  ";
