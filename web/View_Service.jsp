          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                         ...
                         <li><a href="View_Service.jsp" class="smoothScroll">VIEW SERVICES</a></li>
                         <li><a href="Modify_Service.jsp" class="smoothScroll">MODIFY SERVICES</a></li>
		...
		<div class="clear"> </div>
		    ...
		    <div class="wrap">
		    	<div class="content">
                            ...
                            <center>
                            <br><br>
                             <br><br><b><h4><font size="5px" color="#1E90FF" >SERVICE DETAILS</font></h4></b>
                         <br>
                           <br>
        <div class="form-wrapper">  
                            <table border="3">
                                <tr><th>SERVICE ID</th><th>SERVICE NAME</th><th>SERVICE DESCRIPTION</th><th>AMOUNT PER DATE</th></tr>
                                <%
