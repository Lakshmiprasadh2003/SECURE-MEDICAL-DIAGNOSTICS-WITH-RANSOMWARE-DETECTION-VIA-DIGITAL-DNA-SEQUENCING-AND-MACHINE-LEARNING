          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                         ...
                         <li><a href="Services.jsp" class="smoothScroll">ADD SERVICES</a></li>
                         <li><a href="Partner.jsp" class="smoothScroll">ADD PARTNER HOSPITALS</a></li>
                         <li><a href="User_Provider.jsp" class="smoothScroll">VIEW USER DETAILS</a></li>
                         <li><a href="Add_Doctors.jsp" class="smoothScroll">ADD DOCTORS DETAILS</a></li>
               ...
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                         <div class="about-info">
                              <h2 class="wow fadeInUp" data-wow-delay="0.6s">WELCOME TO PROVIDER</h2>
