     ...
     <br>
		    ...
		    <div class="wrap">
		    	<div class="content">
                            ...
                            <center>
                                ...
                                <br><br><b><h4><font size="5px" color="#1E90FF" >ADD NEW SERVICES</font></h4></b>
        ...
        <div class="form-wrapper">
                                <table>
                                    ...
                                    <tr> <td>HOSPITAL NAME</td><td>:</td><td><input type="text" value="" name="S_Name" id="S_Name" required style="width: 204px;"></td></tr>
                                    <tr> <td>HOSPITAL DESCRIPTION</td><td>:</td><td><textarea  name="Desc" id="Desc" required style="height: 69px; width: 204px" ></textarea></td></tr>
                                    <tr> <td>HOSPITAL CONTACT NUMBER</td><td>:</td><td><input type="text" value="" name="Amount" id="Amount" required style="width: 204px;"></td></tr>
                                    <tr> <td>HOSPITAL ADDRESS</td><td>:</td><td><input type="text" value="" name="Addr" id="Addr" required style="width: 204px;"></td></tr>
                                </table><BR>
                                <BR>
