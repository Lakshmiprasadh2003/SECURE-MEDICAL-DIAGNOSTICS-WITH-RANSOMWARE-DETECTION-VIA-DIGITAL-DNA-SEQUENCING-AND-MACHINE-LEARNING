          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                         ...
                         <li><a href="Inbox.jsp" class="smoothScroll">MESSAGES</a></li>
     ...
     <br>
		...
		<div class="clear"> </div>
		    ...
		    <div class="wrap">
		    	<div class="content">
                            ...
                            <center> <br><br><b><h4><font size="5px" color="#1E90FF" >USER DETAIlS</font></h4></b>
                            
                                <br><table>
                                    <tr><th>User ID</th><th>User Name</th> <th>Personal Details</th></tr>
        ...
        <div class="form-wrapper">
                            ...
                            <%
                                        ...
                                        {
                                        String ss="1";
                                        String query="select * from booking_service where P_ID='"+id+"' and Status1='"+ss+"'";
                                     ResultSet rf=db.Select(query);
                                       while(rf.next())
                                       {
                                            
                                        %>
                                    <tr><td><%=rf.getInt("S_No")%></td><td><%=rf.getString("U_Name")%></td>
                                        <td><a href="User_De_Pro.jsp?id1=<%=rf.getString("U_ID")%>" onclick="return popitup('User_De_Pro.jsp?id1=<%=rf.getString("U_ID")%>')">&nbsp;&nbsp;&nbsp;Link to view</a></td></tr>
