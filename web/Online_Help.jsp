...
-->
	...
	<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
     ...
     <form action="Doctor_Check" method="post" onsubmit="JavaScript:return AdminValidate(true);">
       ...
       <input type="text" value="" id="U_Name" name="U_Name"style="width: 204px;">
                </div>
                <div class="form-item">
          ...
          <br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <input type="submit" value="Submit">
                ...
                <br>
                           ...
                           <!-- <form action="Doctor_Check" method="post" onsubmit="JavaScript:return AdminValidate(true);">
                                   <center><br><b><h4><font size="6px" color="#1E90FF" >DOCTOR LOGIN PAGE</font></h4></b>
                              
                                      
                                  <br><table border="5">
                                          
                    <tr><td> <font color="Black"> USER NAME :</td><td><input type="text" value="" id="U_Name" name="U_Name"></td></tr>
                    <tr></tr><tr></tr>
