     ...
     <br>
        ...
        <div class="form-wrapper">   
                                ...
                                <table border="2">
                                    ...
                                    <tr><th>S_No</th><th>U_Id</th><th>User Name</th><th>Hospital_Id</th><th>Doctor_Id</th><th>Symptom</th><th>Doctor Replay</th></tr>
                           
                            <%
                                        String s="1";
                                        String query="Select * from user_treatment where U_ID='"+id+"' and Status1='"+s+"' ";
                                        ...
                                        while(rd.next())
                                        {
                                         ...
                                         <td><%=rd.getInt("H_ID")%></td>
                                           ...
                                           <td><%=rd.getString("Symptom")%></td>
                                            <td><%=rd.getString("D_Replay")%></td>
                                            <td><a href="Counsel_Privacy.jsp?id1=<%=rd.getString("S_NO")%>">Set Privacy</a></td>
