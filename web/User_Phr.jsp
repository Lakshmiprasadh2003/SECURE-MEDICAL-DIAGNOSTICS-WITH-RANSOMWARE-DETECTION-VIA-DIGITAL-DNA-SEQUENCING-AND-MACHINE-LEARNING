...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
     ...
     <br>
        ...
        <div class="form-wrapper">  
                                    ...
                                    <table border="3">
                                        <tr>
                                            <td>User Name</td><td>:</td><td><input type="text" value="<%=rs.getString("Aadhar_ID")%>" name="U_Name"  style="width: 204px;"  readonly></td>
                                        </tr>
                                        <tr>
                                            <td>User Id</td><td>:</td><td><input type="text" value="<%=rs.getString("S_No")%>" name="U_Id" style="width: 204px;" readonly></td>
                                        </tr> 
                                        <tr>
                                            <td>Mobile No</td><td>:</td><td><input type="text" value="<%=rs.getString("U_Ph")%>" name="U_Ph" style="width: 204px;" readonly></td>
                                        </tr> 
