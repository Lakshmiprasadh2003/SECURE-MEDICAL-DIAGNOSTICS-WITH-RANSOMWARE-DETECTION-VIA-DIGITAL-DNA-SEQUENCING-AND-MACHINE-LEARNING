	...
	<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
     ...
     <br>
        ...
        <div class="form-wrapper">
                            <table border="3">
                                <tr><th>HOSPITAL ID</th><th>HOSPITAL NAME</th><th>HOSPITAL DESCRIPTION</th><th>CONTACT NUMBER</th><th>ADDRESS</th><th>MODIFY</th><th>DELETE</th></tr>
                                <%
                                ...
                                <td><a href="Modify1.jsp?id=<%=rs1.getInt("S_No")%>">Click Here</a></td>
                                  <td><a href="Delete1.jsp?id=<%=rs1.getInt("S_No")%>">Click Here</a></td>
                                </tr>
